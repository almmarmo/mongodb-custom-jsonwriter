...
namespace WZ.Enterprise.InfoPerson.DataAccess.MongoDb
{
    ...
    /// </summary>
    public class CustomJsonWriter : BsonWriter
    {
        // private fields
        private TextWriter _textWriter;
        private InternalJsonWriterContext _context;
        private JsonWriterSettings _jsonWriterSettings;
        ...
        public CustomJsonWriter(TextWriter writer, JsonWriterSettings settings)
            : base(settings)
        {
            if (writer == null)
            {
        ...
        public override void WriteStartArray()
        {
            ...
            _context = new InternalJsonWriterContext(_context, ContextType.Array, Settings.IndentChars);
        ...
        public override void WriteStartDocument()
        {
            ...
            _context = new InternalJsonWriterContext(_context, contextType, Settings.IndentChars);
